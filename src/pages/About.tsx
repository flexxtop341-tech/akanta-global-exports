...
const About = () => {
  return (
    <>
      ...
      {/* Our Journey — with logistics background */}
      <section className="py-24 relative overflow-hidden">
        <img src={aboutLogisticsBg} alt="" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-16">
            ...
            <motion.div variants={fadeUp} custom={2} className="gold-divider mx-auto mb-4" />
            <motion.p variants={fadeUp} custom={3} className="text-primary-foreground/70 max-w-xl mx-auto">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="absolute left-1/2 top-0 bottom-0 w-px -translate-x-1/2 hidden md:block overflow-hidden">
              <motion.div
                ...
                className="w-full bg-gradient-to-b from-gold/50 via-gold/30 to-transparent"
              />
            </div>
            ...
            {milestones.map((m, i) => (
              ...
              >
                <div className={`w-full md:w-1/2 ${i % 2 === 0 ? 'md:pr-14 md:text-right' : 'md:pl-14'}`}>
                  ...
                  >
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-gold/20 to-transparent rounded-2xl opacity-0 group-hover/milestone:opacity-100 blur-sm transition-opacity duration-500" />
                    <div className="relative bg-card/90 backdrop-blur-xl rounded-2xl p-6 border border-border/50 shadow-[0_8px_30px_-10px_hsl(var(--gold)/0.15)]">
